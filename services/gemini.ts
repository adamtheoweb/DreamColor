...
export const sendChatMessage = async (history: ChatMessage[], newMessage: string): Promise<string> => {
  const chat = ai.chats.create({
    model: TEXT_MODEL,
    config: {
      systemInstruction: "You are a creative assistant for a coloring book app. Help users brainstorm creative themes (e.g., 'Cyberpunk City', 'Floral Mandalas', 'Space Dinosaurs'). Keep responses short, encouraging, and fun.",
    },
